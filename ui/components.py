...
def create_fact_check_panel(fact_check_results: list[FactCheckResult]) -> str:
    ...
    if not fact_check_results:
        return """
        <div class="fact-check-empty" style="color: #b0b0b0 !important;">
    ...
    panel_html = f"""
    <div class="fact-check-panel" style="color: #e0e0e0 !important;">
...
def format_message_with_citations(
    ...
    message_html = f"""
    <div class="message-with-citations" style="color: #e0e0e0 !important;">
        {highlighted_text}
    </div>
